...
public class SimpleDate {
    ...
    // constructors
    public SimpleDate(int m, int d, int y) throws BadMonthException {
        checkMonth(m);
        month = m;
        day = d;
        year = y;
    ...
    public SimpleDate(int m, int d) throws BadMonthException {
        checkMonth(m);
        month = m;
        day = d;
    ...
    public SimpleDate(String date) throws BadMonthException {
    ...
    public void setMonth(int m) throws BadMonthException {
        checkMonth(m);
        month = m;
    }
    ...
    private void checkMonth(int m) throws BadMonthException {
        if(m < 1 || m > 12)
